...
const Music_list = () => {
  return (
    <>
    <div className='grid grid-cols-4 gap-90 mt-2.5 group rounded px-1 py-1 hover:bg-neutral-500/20 duration-200 cursor-pointer'>
        <div className='flex items-center gap-3'>
            <h1 className='text-neutral-500 font-bold'>1</h1>
            <img className='h-13 rounded-lg' src={img1} />
            <div>
        ...
        <div className='flex items-center'>
            <h1 className='text-neutral-500 font-semibold'>Jan 3, 2025</h1>
        </div>
        <div className='flex items-center'>
